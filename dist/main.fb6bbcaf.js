...
petForm.addEventListener('submit', fetchAnimals); //Fetch function from API

var fetchAnimals = function fetchAnimals(e) {
  e.preventDefault();
  var animal = document.querySelector('#animal').value;
  var zipCode = document.querySelector('#zip').value; //fetch animals

  (0, _fetchJsonp.default)("http://api.petfinder.com/pet.find?format=json&key=HMyTLOMOQJlPZPNmPohL7PBAveqtmkZ7v6rTW2knB2T3UyqED6&animal=".concat(animal, "&location=").concat(zipCode, "&callback=callback"), {
